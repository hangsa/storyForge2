...
class WhatIfEngine:
    ...
    async def expand_node(
        ...
        Args:
            ...
            path_context: Optional accumulated context string from root to this node.
    ...
    async def regenerate_node(
        ...
        Args:
            node: The node to regenerate children for.
            tier: Target model tier for the regeneration call.

        Returns:
            The first child node generated by re-expansion.
        """
        children = await self.expand_node(node)
        if not children:
            raise ValueError(
