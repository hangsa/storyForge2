    ...
    def _three_b_config(self, tmp_path):
        cfg = {
            "providers": {"deepseek": {
                ...
                "base_url": "https://x", "api_key_env": "X", "enabled": True,
                "models": {"d": {"display_name": "d", "cost_per_1k_input": 0,
                                  "cost_per_1k_output": 0, "max_tokens": 8}},
            }},
            "tiers": {"tier_1": {"default": "d", "fallback": None, "max_retries": 0,
                                  "max_tokens": 8, "retry_on_failure": False,
                                  "models": [{"id": "d", "provider": "deepseek",
                                              "cost_per_1k_input": 0,
                                              "cost_per_1k_output": 0,
                                              "max_tokens": 8}]}},
        ...
        path = tmp_path / "model_tiers.yaml"
